...
class NetworkInterface {
  private:
    ...
    //手动添加arp表
    uint32_t time{0};
    std::vector<struct mac_ipv4_ttl> arp_table{};
    std::vector<struct mac_ipv4_ttl>::iterator arp_iter{};
    std::vector<struct ipv4_data_ttl> wait_queue{};
    std::vector<struct ipv4_data_ttl>::iterator wait_iter{};
